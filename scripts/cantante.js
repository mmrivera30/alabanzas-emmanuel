...
<body>
  <div class="container">
    ...
    <div class="admin" id="adminPanel">
      ...
      <button onclick="nullFunction()">Agregar nueva alabanza</button>
      <div id="addForm" style="display:none;">
        ...
        <button onclick="nullFunction()">Guardar Alabanza</button>
      </div>
    </div>
  ...
  <script type="module">
    ...
    const ALLOWED_UID = "lWrfrkQSxeNX1JbavN8djnQ3fg62"; // Reemplazar con tu UID real
